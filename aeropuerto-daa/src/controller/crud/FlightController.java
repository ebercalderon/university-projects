...
public class FlightController implements Initializable {
    ...
    public void newFlight(ActionEvent event) throws IOException {
        if (modal == null) {
            showModal();
            modalName.setText("Crear vuelo");
            cbStatus.setValue(FlightState.AGENDADO);
    ...
    public void editFlight(ActionEvent event) {
        ...
        if (validateFields()) {
            ...
            dController.geAirportController().createAlert("El vuelo ha sido editado con éxito.", Route.SUCCESS);
            airport.saveData();
            getData();
            modal.close();
            setModal(null);
    ...
    public void saveFlight(ActionEvent event) {
        if (validateFields()) {
            ...
            dController.geAirportController().createAlert("El vuelo se ha añadido con éxito.", Route.SUCCESS);
            airport.saveData();
            getData();
            modal.close();
            setModal(null);
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        delete.setOnAction((ActionEvent event) -> {
                            ...
                            dController.geAirportController().createAlert("El vuelo fue retirado con éxito.",
                                    Route.SUCCESS);
                            getData();
                        });
                        edit.setOnAction((ActionEvent event) -> {
                            if (modal == null) {
                                ...
                                modalName.setText("Editar el vuelo");
