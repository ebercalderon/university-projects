...
public class AircraftController implements Initializable {
    ...
    public void editAircraft(ActionEvent event) {
        if (validateFields()) {
            ...
            dController.geAirportController().createAlert("La aeronave ha sido editada con éxito.", Route.SUCCESS);
            airport.saveData();
            getData();
            modal.close();
            setModal(null);
    ...
    public void saveAircraft(ActionEvent event) {
        if (validateFields()) {
            if (airline.searchAircraft(txtCode.getText()) == null) {
                ...
                dController.alert(Route.SUCCESS, "La aeronave ha sido añadida con éxito.");
            } else {
                dController.alert(Route.ERROR, "El avión ya existe.");
            }
            airport.saveData();
            getData();
            modal.close();
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        delete.setOnAction((ActionEvent event) -> {
                            ...
                            dController.geAirportController().createAlert("La aeronave fue retirada con éxito.",
                                    Route.SUCCESS);
                            getData();
                        });
