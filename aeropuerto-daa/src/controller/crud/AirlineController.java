...
public class AirlineController implements Initializable {
    ...
    public void editAirline(ActionEvent event) {
        if (validateFields()) {
            ...
            dController.geAirportController().createAlert("La aerolínea ha sido editada con éxito.", Route.SUCCESS);
            airport.saveData();
            airport.loadData();
            getData();
            modal.close();
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        delete.setOnAction((ActionEvent event) -> {
                            ...
                            dController.geAirportController().createAlert("La aerolínea ha sido eliminada con éxito.",
                                    Route.SUCCESS);
                            getData();
                        });
