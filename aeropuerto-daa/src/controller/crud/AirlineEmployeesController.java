...
public class AirlineEmployeesController implements Initializable {
    ...
    public void newEmployee(ActionEvent event) throws IOException {
        if (modal == null) {
            showModal();
            modalName.setText("Crear empleado");
    ...
    public void editEmployee(ActionEvent event) {
        ...
        if (validateFields()) {
            ...
            dController.geAirportController().createAlert(type + " fue editado con éxito.", Route.SUCCESS);
            airport.saveData();
            getData();
            modal.close();
            setModal(null);
    ...
    public void saveEmployee(ActionEvent event) {
        String type = "";
        if (validateFields()) {
            if (cbType.getValue().equals("Piloto")) {
                airline.getPilots()
            ...
            dController.geAirportController().createAlert(type + " se ha añadido con éxito.", Route.SUCCESS);
            airport.saveData();
            getData();
            modal.close();
            setModal(null);
    ...
    public void initTypes() {
        ...
        cbType.getItems().addAll("Piloto", "Asesor");
    }
                ...
                public void updateItem(String item, boolean empty) {
                    ...
                    if (empty) {
                        ...
                        delete.setOnAction((ActionEvent event) -> {
                            ...
                            dController.geAirportController().createAlert(type + " fue eliminado con éxito.",
                                    Route.SUCCESS);
                            airport.saveData();
                            getData();
                        });
                        edit.setOnAction((ActionEvent event) -> {
                            if (modal == null) {
                                ...
                                modalName.setText("Editar empleado");
