...
public class DashboardController implements Initializable {
    ...
    public void init() {
        if (airport.getLogged() != null) {
            ...
            if (airport.getAdminLogged().getRole() == UserRole.MIGRACION) {
                renderToast();
            }
        }
        try {
    ...
    public void renderUser() throws IOException {
        ...
        switch (type) {
            case ("CLIENTE"):
                ...
                break;
            case ("ADMINISTRADOR"):
                loadBar(Route.ADMINISTRADOR);
                break;
            case ("SUPERVISOR"):
                loadBar(Route.CT_SUPERVISOR);
                break;
            case ("MIGRACION"):
                loadBar(Route.MIGRACION);
                break;
            case ("AEROLINEA"):
                loadBar(Route.AEROLINEA);
                break;
        }
    }
