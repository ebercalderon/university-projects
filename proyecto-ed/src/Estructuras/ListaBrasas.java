...
import Nodos.NodoBrasa;

public class ListaBrasas {
    public NodoBrasa cabeza;
    ...
    public void insertar(Producto producto) {
        NodoBrasa nodo = new NodoBrasa(producto);
    ...
    public Producto buscarBrasa(String nombre) {
        System.out.println(nombre);
        NodoBrasa temp = cabeza;
    ...
    public String[] get_Titulo_Brasas(){
    ...
    //Muestra a todas las brasas sin ninguna restricción
    ...
    public boolean eliminarBrasa(Producto producto) {
        if (!estaVacia()) {
            NodoBrasa auxBorrar = cabeza;
            NodoBrasa auxAnterior = null;
