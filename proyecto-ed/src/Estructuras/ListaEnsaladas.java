...
import Nodos.NodoEnsalada;

public class ListaEnsaladas {

    public NodoEnsalada cabeza;
    private int idBebida;
    private int longitud;

    public ListaEnsaladas() {
        this.cabeza = cabeza;
    ...
    public void insertar(Producto producto) {
        NodoEnsalada nodo = new NodoEnsalada(producto);
    ...
    public Producto buscarEnsalada(String nombre) {
        System.out.println(nombre);
        NodoEnsalada temp = cabeza;
    ...
    public String[] get_Titulo_Ensaladas() {
    ...
    //Muestra a todas las ensaladas sin ninguna restricción
    ...
    public boolean eliminarEnsalada(Producto producto) {
        if (!estaVacia()) {
            NodoEnsalada auxBorrar = cabeza;
            NodoEnsalada auxAnterior = null;
