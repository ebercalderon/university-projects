...
public class AllEmpleados extends javax.swing.JFrame {

    DefaultTableModel modelo;

    public void LlenarTabla() {
        modelo = new DefaultTableModel(Sistema.empleado.getEmpleado(), Sistema.empleado.get_Titulo_Empleado());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{       
            ...
            int idcargo = Integer.parseInt(jTextField6.getText());
            Empleado em = new Empleado(usuario, contraseña, nombre, apellido, dni, idcargo, cargo);
            Sistema.empcargo.insertar(em);
            //Sistema.empleado.agregar(em);
        }catch (Exception e) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
                MainEmpleados mc = new MainEmpleados();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AllEmpleados().setVisible(true);
            }
        });
    }
