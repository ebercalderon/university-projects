...
public class LoginEmpleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/mediterraneo-logo (1).png"))); // NOI18N

        jPanel2.setBackground(new java.awt.Color(255, 204, 0));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/trabajando (1).png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Sistema.empleadoActual = Sistema.empleado.validar(usuario, contraseña);
        
        if (Sistema.empleadoActual == null) {
           // if(Sistema.empcargo. == 0){
                JOptionPane.showMessageDialog(null, "BIENVENIDO");
                MainEmpleados EF = new MainEmpleados();
                EF.setVisible(true);
                this.dispose();
            //}else{
               // JOptionPane.showConfirmDialog(null, "Usted no puede entrar aquí");          
            //}
        } else {
